...
# 
# Welcome to Python, IPython Notebook, And Python in Forensics!
# All three of these topics will be covered in this notebook. If you have experience with any, feel free to jump to
# others! If you feel comfortable in all three, feel free to select a different notebook, such as timelines!
# 
...
# 
# The text blocks are prompts that describe the material. I am sorry about typos (spell check doesnt work here)
# 
# Code blocks are python scripts, and they all work together! They can run individually, though can also reference
# eachother. When in doubt, or if an error occurs, try running all of the code blocks in order from top to bottom to
# see if it resolves the error.
# 
# In addition, code blocks can be edited and, in some cases, you do have to do some editing. After running, the
# output (if any) will display below the segment (as will errors). If you cannot fix it, feel free to ask me or to grab a fresh copy from github.
# 
...
# # Python in Forensics
# 
# I find the biggest difference between python scripting and python scripting for forensics to be the use of 3rd party
# libraries and file handling. As opposed to other uses of Python, we are concerned with file metadata more than
# content, and when we are interested in content, we are interested in the structure and metadata about the content
# as well. With this, a lot of 3rd party libraries exist to allow us to look into weird file types and begin to handle this data.
# 
# As you go through this: google is your best friend
# Here are some python search tips:
#  - Start every query with python
#  - If it involves a specific library, the name of it should be the second word
#  - mention the data type of the value that is causing the error
#  - stackoverflow
#  - superuser
# 
# ie. Python lxml cannot parse string value
# 
# When in doubt, paste the entire error
# If still nothing: https://www.reddit.com/r/learnpython

# # Python basics
# 
# I cannot do nearly as good of a job as Learn Python the Hard Way, so I reccomend using their site to walk you
# through the basics. If you are looking to use Python for Forensic purposes, I would reccomend the first 39 examples,
# should take around an hour or two to work through. The remaining examples are important, though not as applicable (except for objective stuff (sort of)).
# 
# Here is the link to the first example: http://learnpythonthehardway.org/book/ex1.html
# 
# ## Quick intro to Python!
# 
# Below is a code block with basic python items. Everything is documented within so read it line by line. I will
# seperate different sections with a new code block to make things easier to understand.
